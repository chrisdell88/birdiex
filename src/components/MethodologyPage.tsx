  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <section className="mb-12">
        ...
        <div className="bg-[#0a0a0a] border border-[#262626] rounded-lg p-5">
          <p className="text-sm text-[#d4d4d4] font-['Inter',system-ui,sans-serif] leading-relaxed mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm font-['Inter',system-ui,sans-serif]">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[#d4d4d4]">STRONGEST BUY -- Highest conviction pick</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-green-600"></span>
              <span className="text-[#d4d4d4]">STRONG BUY -- High confidence value</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-[#22c55e]/50"></span>
              <span className="text-[#d4d4d4]">BUY -- Positive value identified</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-gray-500"></span>
              <span className="text-[#d4d4d4]">HOLD -- Neutral, no clear edge</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-red-400/50"></span>
              <span className="text-[#d4d4d4]">FADE -- Negative value identified</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-red-600"></span>
              <span className="text-[#d4d4d4]">STRONG FADE -- High confidence fade</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-red-500"></span>
              <span className="text-[#d4d4d4]">STRONGEST FADE -- Highest conviction fade</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <div className="bg-[#0a0a0a] border border-[#262626] rounded-lg p-5">
          <p className="text-sm text-[#d4d4d4] font-['Inter',system-ui,sans-serif] leading-relaxed">
            ...
            sourced from <span className="text-[#22c55e] font-medium">DataGolf</span>, our
