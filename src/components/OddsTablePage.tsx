...
export default function OddsTablePage({ data, dataSet, onDataSetChange }: OddsTablePageProps) {
  ...
  // matchups disappear, and outrights settle. Render the placeholder AFTER
  // all hooks have been called (Rules of Hooks: never return early before
  // hooks; React 19's compiler will crash the component if you do).
