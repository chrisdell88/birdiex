...
import { roundOnlyData, cumulativeData, generatedAt } from '../data/cscR1Data';
...
import { r2MatchupOddsData } from '../data/cscR2Matchups';
import { r2OutrightsData } from '../data/cscR2Outrights';
